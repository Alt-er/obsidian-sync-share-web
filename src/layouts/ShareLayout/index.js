...
const themeIcons = {
    light: (
        <>
            <SunIcon className="w-5 h-5 text-base mr-1"></SunIcon> Light
        </>
    ),
    dark: (
        <>
            <MoonIcon className="w-5 h-5 text-base mr-1"></MoonIcon> Dark
        </>
    ),
    system: (
        <>
            <SystemIcon className="w-5 h-5 text-base mr-1"></SystemIcon> System
        </>
    ),
};
